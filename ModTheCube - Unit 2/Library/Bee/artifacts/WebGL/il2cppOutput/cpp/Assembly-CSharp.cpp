...
{
	{
		...
		Vector3__ctor_m376936E6B999EF1ECBE57D990A386303E2283DE0_inline((&L_1), (1.0f), (2.0f), (3.0f), /*hidden argument*/NULL);
		Transform_set_position_mA1A817124BB41B685043DED2A9BA48CDF37C4156(L_0, L_1, NULL);
		// Material material = Renderer.material;
		MeshRenderer_t4B7747212F0B88244BB7790C61AE124BFC15BAAE* L_2 = __this->___Renderer_4;
		...
		Color__ctor_m3786F0D6E510D9CFA544523A955870BD2A514C8C_inline((&L_4), (0.810000002f), (0.239999995f), (0.25f), (0.400000006f), /*hidden argument*/NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Cube_Update_m92E30DF8DDE75DE867ED92B41FAE863601717D7E (Cube_tEB0CADF2ED5CCD174FE21940A8708AFFBC74872B* __this, const RuntimeMethod* method) 
{
	...
	{
		// index++;
		int32_t L_0 = __this->___index_5;
		__this->___index_5 = ((int32_t)il2cpp_codegen_add(L_0, 1));
		// float coeff = Mathf.Sin(Mathf.Log(Time.deltaTime*index));
		float L_1;
		L_1 = Time_get_deltaTime_mC3195000401F0FD167DD2F948FD2BC58330D0865(NULL);
		int32_t L_2 = __this->___index_5;
		float L_3;
		L_3 = logf(((float)il2cpp_codegen_multiply(L_1, ((float)L_2))));
		float L_4;
		L_4 = sinf(L_3);
		V_0 = L_4;
		// if(coeff<0) coeff = 0;
...
IL_0034:
	{
		...
		L_8 = Vector3_op_Multiply_m7F3B0FA9256CE368D7636558EFEFC4AB0E1A0F41_inline((10.0f), L_7, NULL);
		float L_9 = V_0;
		...
		Transform_Rotate_m7EA47AD57F43D478CCB0523D179950EE49CDA3E2(L_11, ((float)il2cpp_codegen_multiply((19.0f), L_12)), (0.0f), (0.0f), NULL);
		// }
		return;
	}
}
